...
<template>
    ...
    >
        ...
        >
            <div
                class="pointer-events-none absolute inset-x-0 top-0 h-20 bg-linear-to-b from-black/70 to-transparent"
            />
            <div
                class="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-linear-to-t from-black/80 to-transparent"
            />
            <div
                ref="backlogPanelRef"
                class="relative z-10 h-full w-full max-w-4xl overflow-y-auto rounded-4xl bg-neutral-950/88 px-6 py-6 shadow-[0_24px_80px_rgba(0,0,0,0.45)] ring-1 ring-white/5"
                @click.stop
            >
                <div class="mb-5 border-b border-white/8 pb-3">
                    <div class="space-y-1.5">
                        ...
                        <h2
                            class="text-[28px] font-medium tracking-[0.01em] text-white/92"
                        >
                            历史记录
                        </h2>
                    </div>
                ...
                <div v-if="backlogItems.length" class="space-y-4 pb-8">
                    <article
                        ...
                        :key="item.id"
                        class="rounded-3xl bg-white/4.5 px-5 py-4 shadow-[0_8px_24px_rgba(0,0,0,0.14)] ring-1 ring-white/6"
                    >
                        <header class="mb-2 text-sm">
                            <div class="min-w-0">
                                <p
                                    class="truncate text-base font-medium text-white/90"
                                >
                                    {{ item.speakerName || "旁白" }}
                                </p>
                                <p
                        ...
                        <p
                            class="whitespace-pre-wrap wrap-break-word text-[15px] leading-8 text-white/76"
                        >
                            {{ item.text }}
                        </p>
                    </article>
                ...
                <div
                    v-else
                    class="flex h-full min-h-60 items-center justify-center rounded-3xl bg-white/[0.035] text-sm font-medium tracking-[0.12em] text-white/42 ring-1 ring-white/6"
                />
            </div>
        </div>
    </div>
