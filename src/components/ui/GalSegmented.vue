...
<template>
  <div
    class="inline-flex items-center gap-1 p-1 rounded-full bg-(--color-md-surface-container-high)"
  >
    <button
      v-for="item in items"
      :key="item.id"
      ...
      :class="
        modelValue === item.id
          ...
          : 'text-(--color-md-on-surface-variant) hover:bg-md-surface-container-highest'
      "
